...
E2E_SCENARIOS = [
    ...
    ("human", "Quero falar com atendente humano, não estou conseguindo resolver"),
    ("human", "Já liguei várias vezes e ninguém responde"),
    ("human", "Fiz orçamento faz 10 dias e nunca retornaram"),
    ("human", "Quero cancelamento e reembolso do serviço"),
]
