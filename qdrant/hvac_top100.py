...
TOP100_FAQ: list[dict[str, Any]] = [
    ...
    faq("Como funciona o orçamento?", "Primeiro a gente entende o serviço pelo WhatsApp. Só instalação split simples e higienização split têm preço fixo. O restante vai para análise técnica de R$50 abatível. Qual serviço você precisa?", None, "onboarding", 15, ("orcamento",)),
    ...
    # Instalação
    faq("Quanto custa para instalar um split?", "Se for split com acesso simples, fica R$800 no Guarujá ou R$850 em Santos, São Vicente e Praia Grande. Me manda cidade, BTU e fotos da unidade interna, externa, quadro de luz e dreno?", "instalacao", "analise_tecnica", 5, ("preco",)),
    faq("O que está incluso na instalação?", "No preço fixo entra instalação split com acesso simples, material padrão, dreno, suporte, fiação básica e teste. Se tiver telhado, escada alta ou distância grande, vira análise de R$50 abatível. Me manda fotos do local?", "instalacao", "analise_tecnica", 10, ("incluso",)),
    faq("Comprei o ar na loja. Vocês instalam?", "Instalamos sim. Se for split com acesso simples, entra no preço fixo; se tiver acesso difícil, precisa análise de R$50 abatível. Me manda foto da caixa, unidade interna, externa e ponto elétrico?", "instalacao", "analise_tecnica", 10, ("equipamento-cliente",)),
    ...
    faq("Quanto tempo demora uma instalação?", "split com acesso simples normalmente resolve no mesmo dia. Telhado, escada alta, distância grande ou sistema maior precisa análise técnica de R$50 abatível. Qual é o seu caso?", "instalacao", "analise_tecnica", 20, ("prazo",)),
    ...
    faq("Tenho vários aparelhos para instalar.", "Ótimo. Se forem split simples, dá para cotar direto por unidade; se tiver acesso difícil ou sistemas diferentes, precisa análise de R$50 abatível. Quantos são e em qual cidade?", "instalacao", "analise_tecnica", 10, ("volume",)),
    ...
    faq("A análise técnica tem custo?", "A análise técnica no local custa R$50 e esse valor abate se você aprovar o orçamento. Só split simples e higienização split têm preço fechado por WhatsApp. Qual é o serviço?", "manutencao", "analise_tecnica", 20, ("visita",)),
    ...
    # Higienização
    faq("Quanto custa para higienizar um split?", "Higienização de split fica R$200 por aparelho. Cassete, duto, splitão ou acesso difícil precisa análise de R$50 abatível. Quantos são?", "higienizacao", "higienizacao_preventiva", 5, ("preco",)),
    faq("O que inclui a higienização?", "No split, inclui limpeza profunda da evaporadora, filtros e partes internas acessíveis, com produto bacteriostático. Quantos aparelhos são?", "higienizacao", "higienizacao_preventiva", 10, ("incluso",)),
    ...
    faq("Tenho vários aparelhos para limpar.", "Perfeito. Se forem split, fica R$200 por aparelho. Se tiver cassete, duto ou acesso difícil, precisa análise de R$50 abatível. Quantos e quais tipos são?", "higienizacao", "higienizacao_preventiva", 10, ("volume",)),
    faq("Quanto tempo demora a higienização?", "split costuma ser mais direto; o tempo depende da quantidade. Cassete, duto ou acesso difícil precisa análise de R$50 abatível. Quantos são?", "higienizacao", "higienizacao_preventiva", 20, ("prazo",)),
